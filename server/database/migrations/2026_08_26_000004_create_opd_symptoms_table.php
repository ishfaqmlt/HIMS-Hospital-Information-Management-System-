...
return new class extends Migration
{
    ...
    {
        Schema::create('opd_symptoms', function (Blueprint $table) {
            ...
            $table->foreignUuid('symptomId')->nullable()->references('id')->on('master_symptoms')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('opd_symptoms');
    }
};
