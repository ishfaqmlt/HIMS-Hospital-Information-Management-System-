...
return new class extends Migration
{
    ...
    {
        Schema::create('opd_physical_exams', function (Blueprint $table) {
            ...
            $table->foreignUuid('physicalExamId')->nullable()->references('id')->on('master_physical_exam')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('opd_physical_exams');
    }
};
